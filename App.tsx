...
function App() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)', color: 'var(--text-primary)', fontFamily: "'Inter',sans-serif" }}>
      <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-6 focus:py-3 focus:bg-violet-600 focus:text-white focus:rounded-full focus:font-bold focus:shadow-2xl focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-black outline-none transition-all">
        Skip to content
      </a>
