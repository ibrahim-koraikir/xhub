      ...
      >
        <div className="p-8">
          <button aria-label="Close installation guide" onClick={onClose}
            className="absolute top-4 right-4 w-11 h-11 rounded-full flex items-center justify-center transition-colors hover:bg-white/10 outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
