...
function App() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)', color: 'var(--text-primary)', fontFamily: "'Inter',sans-serif" }}>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only fixed top-4 left-4 z-[60] p-4 rounded-lg shadow-2xl font-bold transition-all"
        style={{ background: 'var(--violet)', color: 'var(--text-primary)' }}
      >
        Skip to content
      </a>
