  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-black/90 backdrop-blur-xl py-4 border-b border-white/5 shadow-2xl' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a href="#" className="flex items-center gap-2 group focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none rounded-lg transition-transform active:scale-95">
          <div className="w-8 h-8 bg-gradient-to-tr from-brand-600 to-red-600 rounded-lg flex items-center justify-center shadow-lg shadow-brand-900/20 group-hover:rotate-6 transition-transform">
        ...
        <nav className="hidden md:flex space-x-8">
          <a href="#features" className="text-gray-400 hover:text-white transition-colors text-sm font-medium focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none rounded-md px-2 -mx-2">Features</a>
          <a href="#gallery" className="text-gray-400 hover:text-white transition-colors text-sm font-medium focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none rounded-md px-2 -mx-2">Library</a>
          <a href="#testimonials" className="text-gray-400 hover:text-white transition-colors text-sm font-medium focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none rounded-md px-2 -mx-2">Reviews</a>
        </nav>
        <a
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-3 gap-8">
          {features.map((feature, i) => {
            ...
            }[feature.color as 'brand' | 'purple' | 'blue'];

            return (
              <div key={i} className="glass-panel p-8 rounded-3xl hover:bg-white/5 transition-all duration-500 group hover:-translate-y-2 border border-white/5 hover:border-brand-500/30">
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-all duration-500 border ${colorClasses}`}>
  ...
  <footer className="bg-black py-16 border-t border-white/10">
    <div className="container mx-auto px-6">
      ...
      <div className="border-t border-white/5 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
        <p>&copy; {new Date().getFullYear()} XHub App. All rights reserved.</p>
      ...
      <div className="relative bg-slate-900 border border-white/10 w-full max-w-lg rounded-[2.5rem] overflow-hidden shadow-2xl animate-fade-in animate-zoom-in">
        <div className="p-8 md:p-12">
          <button
            ...
            className="absolute top-6 right-6 w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-white/10 transition-all active:scale-95 focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none"
          >
