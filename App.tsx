        ...
        <div className="text-center lg:text-left pt-10 lg:pt-0">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <a
              ...
              className="group relative px-8 py-4 bg-white text-black active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-brand-500 outline-none rounded-full font-bold shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-all duration-300 hover:-translate-y-1 overflow-hidden"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-8 py-4 bg-white/5 border border-white/10 text-white active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-brand-500 outline-none rounded-full font-bold hover:bg-white/10 transition-all duration-300"
            >
      ...
      >
        <div className="p-8 md:p-12">
          <button
            ...
            className="absolute top-6 right-6 w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 transition-colors"
          >
