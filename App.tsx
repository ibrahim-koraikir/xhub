    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-black/90 backdrop-blur-xl py-4 border-b border-white/5 shadow-2xl' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          <a href="#features" className="text-gray-400 hover:text-white transition-all text-sm font-medium focus-visible:ring-2 focus-visible:ring-brand-500 rounded-md outline-none active:scale-95">Features</a>
          <a href="#gallery" className="text-gray-400 hover:text-white transition-all text-sm font-medium focus-visible:ring-2 focus-visible:ring-brand-500 rounded-md outline-none active:scale-95">Library</a>
          <a href="#testimonials" className="text-gray-400 hover:text-white transition-all text-sm font-medium focus-visible:ring-2 focus-visible:ring-brand-500 rounded-md outline-none active:scale-95">Reviews</a>
        </nav>
        <a
        ...
        <div className="text-center lg:text-left pt-10 lg:pt-0">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            ...
            <button
              ...
              className="flex items-center gap-2 px-8 py-4 bg-white/5 border border-white/10 text-white rounded-full font-bold hover:bg-white/10 transition-all duration-300 focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none active:scale-95"
            >
    ...
    <div className="container mx-auto px-6">
      ...
      <div className="border-t border-white/5 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
        ...
        <div className="flex gap-8 mt-4 md:mt-0">
          <a href="#" className="hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-brand-500 rounded-md outline-none active:scale-95">Privacy</a>
          <a href="#" className="hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-brand-500 rounded-md outline-none active:scale-95">Terms</a>
          <a href="#" className="hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-brand-500 rounded-md outline-none active:scale-95">DMCA</a>
        </div>
      </div>
    </div>
  </footer>
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="mt-12">
            <a
              href="https://github.com/ibrahim-koraikir/xhub/releases/latest/download/xhub.apk"
              download
              className="block w-full py-4 bg-brand-500 hover:bg-brand-600 text-white text-center font-bold rounded-2xl transition-all shadow-lg shadow-brand-500/20 focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 outline-none active:scale-[0.98]"
            >
              Get APK Now
            </a>
          </div>
