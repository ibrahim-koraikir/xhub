...
const PhoneMockup: React.FC<{ children?: React.ReactNode; className?: string; imageSrc?: string; priority?: boolean }> = ({ children, className = "", imageSrc, priority = false }) => (
  <div className={`relative mx-auto border-gray-900 bg-gray-900 border-[8px] rounded-[2.5rem] h-[580px] w-[280px] shadow-2xl flex flex-col overflow-hidden ring-1 ring-white/20 ${className}`}>
    {/* Hardware Buttons */}
    <div className="h-[32px] w-[3px] bg-gradient-to-r from-gray-800 to-gray-700 absolute -left-[10px] top-[72px] rounded-l-lg ring-1 ring-white/5 shadow-inner"></div>
    <div className="h-[46px] w-[3px] bg-gradient-to-r from-gray-800 to-gray-700 absolute -left-[10px] top-[124px] rounded-l-lg ring-1 ring-white/5 shadow-inner"></div>
    <div className="h-[46px] w-[3px] bg-gradient-to-r from-gray-800 to-gray-700 absolute -left-[10px] top-[178px] rounded-l-lg ring-1 ring-white/5 shadow-inner"></div>
    <div className="h-[64px] w-[3px] bg-gradient-to-l from-gray-800 to-gray-700 absolute -right-[10px] top-[142px] rounded-r-lg ring-1 ring-white/5 shadow-inner"></div>
    ...
    <div className="rounded-[2rem] overflow-hidden w-full h-full bg-slate-900 relative">
      ...
      {/* Screen Glare */}
      <div className="absolute inset-0 z-20 pointer-events-none opacity-20 bg-gradient-to-tr from-transparent via-white/10 to-transparent rotate-12 scale-150"></div>
    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-black/90 backdrop-blur-xl py-4 border-b border-white/5 shadow-2xl' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-gradient-to-tr from-brand-600 to-red-600 rounded-lg flex items-center justify-center shadow-lg shadow-brand-900/20" aria-hidden="true">
        ...
        <a
          ...
          className="bg-white text-black hover:bg-gray-100 font-semibold py-2 px-6 rounded-full transition-all duration-300 text-sm shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transform hover:-translate-y-0.5 active:scale-[0.98]"
        >
        ...
        <div className="relative h-[600px] flex items-center justify-center lg:perspective-[2000px] group">
          ...
          <div className="relative z-20 transition-transform duration-700 hover:scale-105 animate-float">
            ...
            <div className="absolute -right-8 top-32 bg-black/40 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl flex items-center gap-4 animate-bounce" style={{ animationDuration: '4s' }}>
              <div className="w-10 h-10 rounded-full bg-green-500/20 text-green-500 flex items-center justify-center border border-green-500/30" aria-hidden="true">
            ...
            <div className="absolute -left-12 bottom-40 bg-black/40 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl flex items-center gap-4 animate-bounce" style={{ animationDuration: '5s', animationDelay: '1s' }}>
              <div className="w-10 h-10 rounded-full bg-brand-500/20 text-brand-500 flex items-center justify-center border border-brand-500/30" aria-hidden="true">
  ...
  <section id="features" className="py-32 bg-black relative border-t border-white/5 scroll-mt-24">
    <div className="container mx-auto px-6">
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="glass-panel p-8 rounded-3xl hover:bg-white/5 transition-all duration-300 group hover:-translate-y-2 border border-white/5 active:scale-[0.98] hover:shadow-[0_0_30px_rgba(244,63,94,0.1)]">
          <div className="w-14 h-14 rounded-2xl bg-brand-500/10 text-brand-500 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-brand-500/20" aria-hidden="true">
        ...
        <div className="glass-panel p-8 rounded-3xl hover:bg-white/5 transition-all duration-300 group hover:-translate-y-2 border border-white/5 active:scale-[0.98] hover:shadow-[0_0_30px_rgba(244,63,94,0.1)]">
          <div className="w-14 h-14 rounded-2xl bg-purple-500/10 text-purple-500 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-purple-500/20" aria-hidden="true">
        ...
        <div className="glass-panel p-8 rounded-3xl hover:bg-white/5 transition-all duration-300 group hover:-translate-y-2 border border-white/5 active:scale-[0.98] hover:shadow-[0_0_30px_rgba(244,63,94,0.1)]">
          <div className="w-14 h-14 rounded-2xl bg-blue-500/10 text-blue-500 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-blue-500/20" aria-hidden="true">
    ...
    <div className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          <div key={i} className="bg-white/5 border border-white/5 p-8 rounded-2xl hover:border-brand-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(244,63,94,0.1)] active:scale-[0.98]">
      ...
      <div className="relative bg-slate-900 border border-white/10 w-full max-w-lg rounded-[2.5rem] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
        <div className="p-8 md:p-12">
          <button
            ...
            className="absolute top-6 right-6 w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-white/10 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
          >
          ...
          <div className="mt-12">
            <a
              href="https://github.com/ibrahim-koraikir/xhub/releases/latest/download/xhub.apk"
              download
              className="block w-full py-4 bg-brand-500 hover:bg-brand-600 text-white text-center font-bold rounded-2xl transition-all shadow-lg shadow-brand-500/20 active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
            >
              Get APK Now
            </a>
          </div>
